    ...
    return(
        <div className="contact" id="contact">
            <div className="email-holder">
                <h1>To contact me.</h1>
                <form action="mailto:shirodeep0987@gmail.com" method="POST" name="EmailForm" encType="multipart/form-data">
                <div className="contact-message">
                   <div className="first-box">
                        <label className="label1" for="email">Email:</label>
                        <input type="email"id="email" className="inputs1" name="email" required/>
                    </div>
                    <div className="second-box">
                        <label  className="label2"for="message">Message:</label>
                        <textarea id="message" className="inputs2" rows="4" cols="29" name="message" required></textarea>
                    </div>
